...
export function HeroSection({
  ...
  return (
    <div className="flex-col-reverse relative bg-gray-100 overflow-hidden flex lg:flex-row">
      <div className="flex-1 flex flex-col justify-center relative z-10 pb-8 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
        <main className="mt-10 mb-10 sm:mb-0 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="inline">Find your</span>{' '}
              <span className="inline text-red-800">perfect</span>{' '}
              <span className="inline">brew with our</span>{' '}
              <span className="inline text-red-800">
                leased coffee machines.
              </span>
            </h1>
            <p className="text-center lg:text-left mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg md:mt-5 md:text-xl lg:mx-30">
