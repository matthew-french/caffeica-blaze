      ...
      <div className="max-w-container-md mx-auto flex w-full flex-col justify-between px-4 xl:px-0">
        <header className="flex justify-end gap-4 pt-8">
          ...
          <Link
            prefetch={false}
            target="_blank"
            href={'https://twitter.com/blazity'}
          ...
          <Link
            prefetch={false}
            target="_blank"
            href={'https://www.instagram.com/blazitysoftware/'}
          ...
          <Link
            ...
            target="_blank"
            href={
              'https://www.youtube.com/channel/UCYDeWaSWiOHn_lUHY-u1VYw/videos'
            }
        ...
        <footer className="mt-auto flex flex-col items-center justify-between pb-8 text-neutral-300 md:flex-row">
          <span className="text-sm">
            2024 © Caffeica. All Rights Reserved.
          </span>
